...
// Simple product card for normal products
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      {/* Custom Order CTA Section - Improved Desktop Layout */}
          ...
          <div className="text-center mb-6">
            <div className="bg-gradient-to-r from-violet-600 to-purple-700 rounded-2xl p-6 mx-4 mb-6 border-2 border-violet-500/30">
              ...
              <div className="flex justify-center">
                <button
                  onClick={async () => {
                    console.log('🔄 Start Custom Order button clicked - setting loading state');
                    setIsCustomOrderLoading(true);
                    try {
                      await new Promise(resolve => setTimeout(resolve, 300));
                      await router.push('/made-to-order');
                    } finally {
                      console.log('✅ Start Custom Order loading complete');
          ...
          <div className="flex justify-center mb-8">
            <div className="relative">
              ...
              <input
                ...
                className="pl-12 pr-4 py-3 bg-white border border-gray-300 text-black placeholder-gray-500 w-80 rounded"
              />
            </div>
          </div>
